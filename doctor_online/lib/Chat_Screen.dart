      ...
      builder: (context,snapshot){
        if(snapshot.hasData)
        {
          ...
          for(var message in  messages)
          {
            ...
            if(msgType == 'image')
            {
              msgBubble = ImageBubble(imagePath: msgText,Sender: msgSender,isMe: msgSender == uEmail);
            }

            else if(msgType == 'text')
            {
              msgBubble = MessageBubble(text: msgText,Sender: msgSender, isMe: msgSender == uEmail);
            }
